    ...
    <section className="relative flex items-center justify-center h-[500px]">
      ...
      <div className="relative z-10 text-center text-white">
        ...
        <div className="flex gap-4 justify-center">
          <a
            href="tel:27999992422"
            target="_blank"
            className="bg-green-600 px-5 py-3 rounded flex items-center gap-2 font-semibold hover:bg-green-700 transition"
          >
            <IoCall />
            Ligue Agora
          </a>
          <a
            href="https://wa.me/5527999992422"
            target="_blank"
